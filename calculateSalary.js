export class CalculateSalary {
  ...
  calculateTaxes() {
    if (this.formInformation.totalSalary >= 58191) {
      this.formInformation.totalSalary = this.formInformation.totalSalary * 0.5;
    } else if (this.formInformation.totalSalary >= 45181) {
      this.formInformation.totalSalary =
        this.formInformation.totalSalary * 0.53;
    } else if (this.formInformation.totalSalary >= 21711) {
      this.formInformation.totalSalary =
        this.formInformation.totalSalary * 0.65;
    } else if (this.formInformation.totalSalary >= 15621) {
      this.formInformation.totalSalary =
        this.formInformation.totalSalary * 0.69;
    } else if (this.formInformation.totalSalary >= 9731) {
      this.formInformation.totalSalary = this.formInformation.totalSalary * 0.8;
    } else if (this.formInformation.totalSalary >= 6791) {
      this.formInformation.totalSalary =
        this.formInformation.totalSalary * 0.86;
    } else {
  ...
  calculateDeductions() {
    this.formInformation.totalSalary =
      this.formInformation.totalSalary * this.formInformation.pensionMoney;
    this.formInformation.totalSalary =
      this.formInformation.totalSalary * this.formInformation.educationFund;
  }
}
